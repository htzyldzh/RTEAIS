...
| [NetCut: Real-Time DNN Inference Using Layer Removal](https://ieeexplore.ieee.org/abstract/document/9474052) | Zandigohar et al.<br>DATE 2021  | Removes selected layers as latency nears the deadline; control via model complexity. |  ○   |  ♢   |    ♦\|♣    |  Ⓒ   |  ✫   | **5.1Heuristic** |                                                 |
...
| [EFFECT-DNN: Energy-efficient Edge Framework for Real-time DNN Inference](https://ieeexplore.ieee.org/abstract/document/10195765) | Zhang et al.<br>WoWMoM 2023  | Nested feedback loop tracking joint QoS and energy targets under fluctuating workloads. |  ○   |  ♡♢  |   ♣♥\|♣    |  Ⓒ   |  ✫   | **5.3Optimization** |      |
...
| [RICH: Heterogeneous Computing for Real-Time Intelligent Control](https://ieeexplore.ieee.org/abstract/document/10993261) |                                      |                                                              |      |      |            |      |      |             |      |
